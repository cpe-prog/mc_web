...
export const Hero = () => {
	...
	return (
		<div className="max-w-[1280px] p-4 pt-16">
			<Container className="flex flex-wrap sm:text-center md:text-center">
				<div className="flex items-center w-full lg:w-1/2">
					<div className="max-w-2xl mb-8">
						...
						<div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row sm:justify-center md:justify-center">
							<a
